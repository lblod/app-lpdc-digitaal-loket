...
- authorise remaining ocmw's to publish via ldes (bct) [LPDC-1725]
- Bump frontend to version [0.34.2](https://github.com/lblod/frontend-lpdc/releases/tag/v0.34.2) [LPDC-1740]
- Bump frontend to version [0.34.3](https://github.com/lblod/frontend-lpdc/releases/tag/v0.34.3)

### Management
- Bump to [v0.57.0](https://github.com/lblod/lpdc-management-service/releases/tag/v0.57.0) [LPDC-1655] [LPDC-1680]
- Bump to [v0.57.1](https://github.com/lblod/lpdc-management-service/releases/tag/v0.57.1) [LPDC-1499]
...
```bash
drc exec -it lpdc-management sh
cd app/migration-scripts/herziening-nodig-delete
npm install --include=dev && SPARQL_URL=http://virtuoso:8890/sparql npm start
```
...
- Update frontend to version 0.28.1 [LPDC-1367]
