...
test(`Urls from ipdc ldes stream are saved with datatype <http://www.w3.org/2001/XMLSchema#string> when processed by ldes-consumer and consequently by delta notifier in lpdc-management for conceptsnapshot creation`, async ({ request }) => {
