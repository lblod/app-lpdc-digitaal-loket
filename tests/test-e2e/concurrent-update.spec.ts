...
test.describe('Concurrent Update', () => {
    ...
    test('Second update should fail', async () => {
        ...
        await expect(toaster.message).toContainText("Error: De productfiche is gelijktijdig aangepast door een andere gebruiker. Refresh en geef je aanpassingen opnieuw in.");
