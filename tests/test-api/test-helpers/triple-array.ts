...
export const Predicates = {
    ...
    conceptInstantiated: new Uri('http://data.lblod.info/vocabularies/lpdc/conceptInstantiated'),
    conceptIsNew: new Uri('http://data.lblod.info/vocabularies/lpdc/conceptIsNew'),
    hasDisplayConfiguration: new Uri('http://data.lblod.info/vocabularies/lpdc/hasConceptDisplayConfiguration'),
